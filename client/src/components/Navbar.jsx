            ...
            <div className='md:flex items-center justify-between bg-purple-400 py-4 md:px-10 px-7'>
                <Link to="/">
                    <div className='font-bold text-2xl cursor-pointer flex items-center text-white'>
                        ...
                        <span className=" text-2xl pl-3">Smart Attendance System</span>
                    </div>
                </Link>
                ...
                <ul className={`md:flex md:items-center md:pb-0 pb-12 absolute md:static bg-purple-500 md:z-auto z-[-1] left-0 w-full md:w-auto md:pl-0 pl-9 transition-all duration-500 ease-in ${open ? 'top-20 ' : 'top-[-480px]'}`}>
                    {
                        Links.map((link) => (
